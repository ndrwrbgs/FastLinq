...
--------- |----------- |------------ |-------------:|--------------:|-----------:|-------:|----------:|
 ...
 Contains |       List |         100 |    29.432 ns |     9.9107 ns |  0.5600 ns |      - |       0 B |
   CopyTo |       List |         100 |   838.962 ns |   222.5926 ns | 12.5769 ns | 0.0086 |      40 B |
     ...
     */
    public class EnumerableWithCountBenchmark
    {
        [Params(
            UnderlyingItemType.Enumerable,
            UnderlyingItemType.List,
            UnderlyingItemType.Collection)]
        ...
        public void Setup()
        {
            ...
            {
                case UnderlyingItemType.Enumerable:
                    this.enumerableWithCount = new EnumerableWithCount<int>(
                        Enumerable.Range(0, this.SizeOfInput),
                        this.SizeOfInput);
                    break;
                case UnderlyingItemType.List:
                    this.enumerableWithCount = new EnumerableWithCount<int>(
                        Enumerable.Range(0, this.SizeOfInput).ToList(),
                        this.SizeOfInput);
                    break;
                case UnderlyingItemType.Collection:
                    this.enumerableWithCount = new EnumerableWithCount<int>(
                        new HashSet<int>(Enumerable.Range(0, this.SizeOfInput)),
                        this.SizeOfInput);
                    break;
                default:
        ...
        public int Count()
        {
            return this.enumerableWithCount.Count;
        }
