...
------------------ |------------ |----------------- |------------:|------------:|----------:|-------:|----------:|
 ...
 Enumerable_System |         100 |              100 | 458.2945 ns | 105.9659 ns | 5.9873 ns | 0.0110 |      48 B |
    ...
    /// </summary>
    public class ElementAtOrDefaultBenchmark
    {
        ...
        {
            var _ = Enumerable.ElementAtOrDefault(this.enumerable, ElementToRequest);
        }
        ...
        {
            var _ = Enumerable.ElementAtOrDefault(this.collection, ElementToRequest);
        }
        ...
        {
            var _ = Enumerable.ElementAtOrDefault(this.ilist, ElementToRequest);
        }
        ...
        {
            var _ = Enumerable.ElementAtOrDefault(this.list, ElementToRequest);
        }
        ...
        {
            var _ = Enumerable.ElementAtOrDefault(this.array, ElementToRequest);
        }
        ...
        //{
        //    var _ = FastLinq.ElementAtOrDefault(this.enumerable);
        //}
        ...
        //{
        //    var _ = FastLinq.ElementAtOrDefault(this.collection);
        //}
        ...
        {
            var _ = FastLinq.ElementAtOrDefault(this.ilist, ElementToRequest);
        }
        ...
        //{
        //    var _ = Enumerable.ElementAtOrDefault(this.enumerable);
        //}
        ...
        //{
        //    var _ = Enumerable.ElementAtOrDefault(this.collection);
        //}
