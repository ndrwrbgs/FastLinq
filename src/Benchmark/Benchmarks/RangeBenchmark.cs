...
namespace Benchmark.Benchmarks
{
    ...
    /*
        ...
        TODO: FastLinq enumeration penalty?
     * 
 ...
 FastLinq |                True | 2147483647 |   100 |         NA |          NA |         NA |    N/A |       N/A |
   System |                True | 2147483647 |   100 |         NA |          NA |         NA |    N/A |       N/A |
    ...
    public class RangeBenchmark
    {
        ...
        [Params(-100, 0, int.MaxValue)] public int Start;

        [Params(0, 1, 10, 100)] public int Count;

        [Benchmark]
        [BenchmarkCategory("System")]
        public void System()
        {
            var result = Enumerable.Range(this.Start, this.Count);
        ...
        {
            var result = global::System.Linq.FastLinq.Range(this.Start, this.Count);
            if (this.EnumerateAfterwards)
            {
                foreach (var item in result) ;
            }
